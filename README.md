...
## Environments
- Preview: https://main--nissan-eds--nimithshetty175959.aem.page/
- Live: https://main--nissan-eds--nimithshetty175959.aem.live/
...
1. Open the `nissan-eds` directory in your favorite IDE and start coding :)
